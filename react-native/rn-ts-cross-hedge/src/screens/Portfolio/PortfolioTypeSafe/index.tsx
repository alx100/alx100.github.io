...
import { fetchSafeChartData } from "../../../api/resources";
...
class PortfolioTypeSafe extends React.PureComponent<any, State> {
    ...
    fetchChartData = (range: number) => {
        fetchSafeChartData(range).then(res =>
...
export default PortfolioTypeSafe;
