...
import { fetchDynamicChartData } from "../../../api/resources";
...
class PortfolioTypeDynamic extends React.PureComponent<any, State> {
    ...
    fetchChartData = (range: number) => {
        fetchDynamicChartData(range).then(res =>
...
export default PortfolioTypeDynamic;
