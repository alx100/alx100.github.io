...
class Withdrawal extends React.Component<ComponentProps, State> {
    ...
    handleModal = (name: string) => {
        this.props.dispatch(
            showModal({
                ...
                elements: (
                    <ModalContents
                        title={[t(name), "", t("withdraw_confirmed_title")]}
                    />
                ),
                closeType: "default"
            })
...
export default connect()(Withdrawal);
