...
(function() {
  // TOGGLE MOBILE MENU
  var button = document.querySelector(".navigation .btn-toggle");
  var menu = document.querySelector(".navigation .navigation__list");
...
(function() {
  ...
  // DEPARTURE DAY FILLING
  var arrivalInput = document.querySelector("#date-arrival");
  var durationInput = document.querySelector("#duration-days");
  var departureInput = document.querySelector("#date-departure");
  ...
  function initDates () {
    var departure = moment().format("YYYY-MM-DD");
    var duration = Number(durationInput.value);
    var arrival = moment().subtract(duration, "days").format("YYYY-MM-DD");
  ...
  function changeDepartureDate () {
    var arrival = moment(arrivalInput.value, "YYYY-MM-DD");
    var duration = Number(durationInput.value);
    var departure = arrival.add(duration, "days").format("YYYY-MM-DD");
  ...
  // CHANGING QUANTITY OF TRAVELLERS
  var travellersInput = document.querySelector("#number-of-travellers");
  ...
  function changeTravellers () {
    ...
    var area = document.querySelector(".form-travellers");
    ...
    if (travellersDelta > 0) {
      ...
      for (var ip = previousTravellersQuantity; ip < currentTravellersQuantity; ip++) {
        ...
        div.classList.add("form-travellers__inner");
        div.innerHTML = html;
  ...
  // MAKING PLUS/MINUS BUTTONS IN .FORM-NUMBER LIVE
  var elements = document.querySelectorAll(".js-number");
  ...
  function initNumberField (parent) {
    ...
    minus.addEventListener("tap", function() {
      changeNumber(false);
      if (input == document.querySelector("#number-of-travellers")) {
        changeTravellers();
      }
  ...
  form.addEventListener("submit", function(event) {
    ...
    request(data, function(response) {
      ...
      var area = document.querySelector(".form-file__inner");
      area.innerHTML = "";
    });
  ...
  // MODAL WINDOW TOGGLE
  var submitButton = form.querySelector(".form__submit .btn");
  submitButton.addEventListener("tap", function() {
    if (form.checkValidity() !== true) {
      showRequired();
      modalToggle(".modal-error");
    }
  });

  function showRequired() {
    var inputArray = form.querySelectorAll("input[required]");
    for (var i = 0; i < inputArray.length; i++) {
      var currentInput = inputArray[i];
      if (currentInput.value === ""){
        currentInput.style.cssText = "outline: 1px solid #ff0000";
      } else {
        currentInput.style.cssText = "outline: none";
      }
    }
  }

  function modalToggle(className) {
    var div = document.querySelector(className);
    var divInner = div.querySelector(className + "__inner");
    var button = div.querySelector(".btn--modal");

    div.classList.add("show");
    divInner.classList.add("show");
    button.addEventListener("tap", function() {
      div.classList.remove("show");
      divInner.classList.remove("show");
    });
  }
  ...
  function preview(file) {
    ...
    if (file.type.match(/image.*/)) {
      ...
      if (counter === 0) {
        dropzone.classList.add("in-progress");
      }
      counter = counter + 1;
      ...
      reader.addEventListener("load", function(event) {
        ...
        var div = document.createElement("div");
        div.classList.add("form-file__item");
        div.innerHTML = html;

        area.appendChild(div);

        div.querySelector(".form-file__del").addEventListener("tap", function(event) {
          event.preventDefault();
          removePreview(div);
        });
        ...
        counter = counter - 1;
        if (counter === 0) {
          dropzone.classList.remove("in-progress");
        }
